...
module.exports = class PrimerMigracion1757551251952 {
    ...
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE \`Usuario\` (\`id\` int NOT NULL AUTO_INCREMENT, \`username\` varchar(50) NOT NULL, \`password\` varchar(255) NOT NULL, \`email\` varchar(100) NOT NULL, \`celular\` varchar(20) NULL, \`rol\` enum ('usuario', 'propietario', 'admin') NOT NULL, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), UNIQUE INDEX \`IDX_fc2564b581e02a535b31470a00\` (\`username\`), UNIQUE INDEX \`IDX_c2591f33cb2c9e689e241dda91\` (\`email\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
